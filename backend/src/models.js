...
seatSchema.index({ theater: 1, label: 1 }, { unique: true });
...
const showtimeSeatSchema = new Schema(
  {
    ...
    holdBy: { type: Schema.Types.ObjectId, ref: "User" },
    holdExpiresAt: Date,
  },
  { timestamps: true },
);
...
const bookingSchema = new Schema(
  {
    ...
    seats: [{ type: Schema.Types.ObjectId, ref: "ShowtimeSeat" }],
    seatLabels: [String],
    subtotal: Number,
    serviceFee: Number,
    total: Number,
...
export const ShowtimeSeat = model("ShowtimeSeat", showtimeSeatSchema);
